...
def welcome():
    ...
    <h2>List of all available Honolulu, HI API routes</h2>
    <ol>
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <h2>Thank you for browsing</h2>
    <h2>Hope you had a nice time in Honolulu, Hawaii?</h2>
    </html>
...
def precipitation():
    ...
    results_precipitation = session.query(Measurement.date, Measurement.prcp).filter(Measurement.date >= last_year).all()
